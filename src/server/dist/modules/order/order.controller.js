...
class OrderController {
    constructor(orderService) {
        ...
        this.acceptQuotation = (0, asyncHandler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            const { orderId } = req.params;
            if (!userId) {
        ...
        this.rejectQuotation = (0, asyncHandler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedTransaction = yield this.orderService.rejectQuotationForOrder(orderId, userId);
            (0, sendResponse_1.default)(res, 200, {
