...
import { useGetOverviewQuery, useGetProductPerformanceQuery } from "@/app/store/apis/AnalyticsApi";
...
const Dashboard = () => {
  ...
  const { data: overviewData, isLoading: loading, error } = useGetOverviewQuery(queryParams as any);
